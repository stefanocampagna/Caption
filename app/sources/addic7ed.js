...
export async function searchFile(rawFile, language) {
  ...
  const splitFileName = file.name.match(/s([0-9]{1,2})\s*e([0-9]{1,2})|([0-9]{1,2})x([0-9]{1,2})|([0-9]{1,2})e([0-9]{1,2})|s([0-9]{1,2})([0-9]{1,2})/i);
...
export async function searchQuery(query, language) {
  const splitQuery = query.match(/s([0-9]{1,2})\s*e([0-9]{1,2})|([0-9]{1,2})x([0-9]{1,2})|([0-9]{1,2})e([0-9]{1,2})|s([0-9]{1,2})([0-9]{1,2})/i);
